  ...
  return {
    data: {
      ...
      pid: {
        ...
        kd: 0.0,
        integral: 12847.3,
        basis: { total_w_per_unit: 48.5, included_arrays: ['Zuid', 'West'] },
      },
      arrays: [
        {
          name: 'Zuid',
          ...
          setpoint_min: 0.0,
          setpoint_max: 100.0,
          power_sensor_entity: 'sensor.zuid_power',
          w_per_unit: 38.5,
          settling_time_s: 12,
          settling_down_s: 10,
          settling_up_s: 12,
          derived_max_power_w: 3850.0,
        ...
        },
        {
          ...
          setpoint_min: 0.0,
          setpoint_max: 100.0,
          power_sensor_entity: 'sensor.west_power',
          w_per_unit: 10.0,
          settling_time_s: 15,
          settling_down_s: null,
          settling_up_s: null,
          derived_max_power_w: null,
